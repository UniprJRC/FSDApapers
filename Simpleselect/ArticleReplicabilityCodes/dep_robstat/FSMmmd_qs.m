function [mmd,Un,varargout] = FSMmmd_qs(Y,bsb,varargin)
...
% TEST ORDER STATISTIC VS SORT: SEARCH FOR ostype
options=struct('ostype','sort','init',initdef,'plots',0,'msg',1,'nocheck',0,'bsbsteps',bsbstepdef);
