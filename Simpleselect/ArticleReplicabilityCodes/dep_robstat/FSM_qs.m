function [out , tend_internal]=FSM_qs(Y,varargin)
...
options=struct('ostype','sort','m0',v+1,'init',hdef,'crit',critdef,'rf',0.95,...
...
if n<5000
    [mmd,Un,bb,tend_internal] = FSMmmd_qs(Y,bs,'ostype',ostype,'init',init,'nocheck',1,'msg',msg);
else
    [mmd,Un,~,tend_internal] = FSMmmd_qs(Y,bs,'ostype',ostype,'init',init,'nocheck',1,'msg',msg);
end
