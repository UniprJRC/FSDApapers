function [out , tend_internal]=FSMeasy_qs(Y,varargin)
...
if n<5000
    [mmd,Un,bb,tend_internal] = FSMmmdeasy_qs(Y,bs,'ostype',ostype,'init',init,'msg',msg);
else
    [mmd,Un,~,tend_internal] = FSMmmdeasy_qs(Y,bs,'ostype',ostype,'init',init,'msg',msg);
end
